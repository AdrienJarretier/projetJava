...
public abstract class GitObject {
	...
	/**
	 * Instancie un objet Git a partir d'un fichier ce fichier se trouve dans un
	 * des dossiers de .git/objects mais pas dans un pack
	 * 
	...
	/**
	 * Instancie un objet Git a partir d'un nom Cet objet est suppose se trouver
	 * dans un pack
	 * 
	 * @param _name
	 *            le nom de l'objet (40 caracteres >= hexadecimal)
	 * @param _gitInstance
	 *            l'instance Git contenant cet objet
	 * @param offset
	 *            la position de cet objet dans le pack
	 * @param pack
	 *            le pack ou se trouve cet objet
	 */
