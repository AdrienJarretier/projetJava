...
public class VisualisationObjetsGit extends Application {
	...
	/**
	 * ouvre une fenetre de selection de dossier, le dossier doit etre un depot
	 * git valide
	 * 
	 * @param stage
	 *            conteneur parent a cette fenetre de selection de dossier
	 * 
	 ...
	 */
	private void openGitRepository(Stage stage) throws NotGitRepositoryException, DirectoryDoesNotExistException,
			NotGitDirectoryException, IOException, Exception {
		...
		menuFileOpen.setOnAction((ActionEvent t) -> {
			...
			do {
				try {
					...
					// si openGitRepository renvoie null on ne fait aucun
					// traitement
